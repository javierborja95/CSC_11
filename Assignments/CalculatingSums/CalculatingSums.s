...
main: 
	...
	ldr r0, = specifier //Load single format specifier
	...
	mov r4, #0          //r4 will be the integer sum
	mov r5, #0          //r5 will be the sqr sum
	mov r6, #0          //r6 will be the counter
...
while_CountLtInput:
	...
	add r6, r6, #1      //counter++
	add r4, r4, r6      //intSum=intSum + counter
	mul r7, r6, r6      //r7=square of the counter
	add r5, r5, r7      //sqrSum=sqrSum + square of counter
